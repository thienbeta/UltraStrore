...
{
    /// <inheritdoc />
    public partial class sdifujhds : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_loai_san_pham = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_nguoi_dung = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    ...
                    ngay_ky = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_thuong_hieu = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dieu_kien = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    so_luong = table.Column<int>(type: "int", nullable: true),
                    trang_thai = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_ctdh = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_dia_chi = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    ma_nguoi_dung = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    ho_ten = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    sdt = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    mo_ta = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    dia_chi = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_don_hang = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    ma_nguoi_dung = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    ma_nhan_vien = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    ngay_dat = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ma_thuong_hieu = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    ma_loai_san_pham = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    ...
                    example = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_ctgh = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_video = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ma_yeu_thich = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
                    ma_san_pham = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    ma_nguoi_dung = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: true),
                    so_luong_yeu_thich = table.Column<int>(type: "int", nullable: true),
                    ngay_yeu_thich = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
